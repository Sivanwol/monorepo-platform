      ...
      <li className="hidden lg:block">
        <form action="https://formbold.com/s/unique_form_id" method="POST">
          <div className="relative w-full max-w-[300px]">
            <button
              className="text-dark dark:text-dark-6 absolute left-5 top-1/2 -translate-y-1/2 hover:text-primary dark:hover:text-primary"
              title="Search"
            >
              <svg
            ...
            <input
              type="text"
              placeholder="Search"
              className="border-stroke bg-gray-2 pl-13.5 text-dark dark:border-dark-4 dark:bg-dark-3 w-full rounded-full border py-3 pr-5 focus:border-primary focus:outline-none dark:text-white dark:focus:border-primary xl:w-[300px]"
            />
          </div>
        </form>
      </li>
