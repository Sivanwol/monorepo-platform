...
export const UserProfilePage = ({
  ...
  const firstNameEditRender = (<FormControl sx={{ width: '25ch' }}>
    <InputLabel htmlFor="firstName" shrink>
      {translations.firstName}
    </InputLabel>);
    <Input id="firstName" aria-describedby="my-helper-text" value={user.firstName} />
  </FormControl>);
  ...
  const lastNameEditRender = (<><FormControl sx={{ width: '25ch' }}>
    <InputLabel htmlFor="lastName" shrink>
      {translations.lastName}
    </InputLabel>
    <Input id="lastName" aria-describedby="my-helper-text" value={user.lastName} />
  </FormControl></>);
